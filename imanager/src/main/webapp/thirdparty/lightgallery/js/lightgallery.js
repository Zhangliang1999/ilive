...
(function($, window, document, undefined) {
    ...
    Plugin.prototype.build = function(index) {
        ...
        _this.$outer.on('mousemove.lg%20click.lg%20touchstart.lg', function() {
    ...
    Plugin.prototype.structure = function() {
        ...
        _this.setTop();
        $(window).on('resize.lg%20orientationchange.lg', function() {
            setTimeout(function() {
                _this.setTop();
            }, 100);
        });
    ...
    Plugin.prototype.loadContent = function(index, rec, delay) {
        ...
        _this.$slide.eq(index).find('.lg-object').on('load.lg%20error.lg', function() {
