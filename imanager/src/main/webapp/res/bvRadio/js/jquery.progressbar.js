	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: 'image/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'image/progressbg_red.gif',
									30: 'image/progressbg_orange.gif',
									70: 'image/progressbg_green.gif'
								},
