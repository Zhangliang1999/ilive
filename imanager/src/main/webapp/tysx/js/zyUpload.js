	...
	$.fn.zyUpload = function(options,param){
		...
		return this.each(function(){
			...
			var defaults = {
					...
					url              : document.location.host+"/admin/file/o_uploadFile.do",  	// 上传文件的路径
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
					...
					html += '	<input id="fileType" type="hidden" name="fileType" value="image"/>';
					html += '	<input type="hidden" id="serverGroupId" name="serverGroupId" value="">';
