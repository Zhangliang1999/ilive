 ...
 * 
 * @author Ben Alex
 * @version $Id: UserDetailsService.java,v 1.1 2011/12/06 01:36:08 administrator
 *          Exp $
 */
public interface UserDetailsService {
	 ...
	 */
	UserDetails loadUser(Long userId, String username) throws UsernameNotFoundException, DataAccessException;
}
