...
public class DateTypeEditor extends PropertyEditorSupport {
	...
	public static final DateFormat DF_HALF = new SimpleDateFormat("yyyy-MM-dd HH:mm");
	/**
	 * 短类型日期长度
	 */
	...
	public static final int HALF_DATE = 16;
	...
	public void setAsText(String text) throws IllegalArgumentException {
		...
		try {
			...
			} else if(text.length()<=HALF_DATE) {
				setValue(new java.sql.Timestamp(DF_HALF.parse(text).getTime()));
			}else {
