...
public class CosMultipartRequest {
	...
	protected Hashtable<String, List<String>> parameters = new Hashtable<String, List<String>>(); // name
																									// -
																									// Vector
																									// of
																									// values
	protected Map<String, UploadedFile> files = new HashMap<String, UploadedFile>(); // name
																						// -
																						// UploadedFile
