package com.bvRadio.iLive.common.web.springmvc;
...
public class SimpleFreeMarkerView extends AbstractTemplateView {
	...
	protected FreeMarkerConfig autodetectConfiguration() throws BeansException {
		try {
			...
			throw new ApplicationContextException("Must define a single FreeMarkerConfig bean in this web application context "
					+ "(may be inherited): FreeMarkerConfigurer is the usual implementation. " + "This bean may be given any name.", ex);
		}
	}
