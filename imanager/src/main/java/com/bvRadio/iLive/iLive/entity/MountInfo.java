...
public class MountInfo implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2500371207669072807L;
	/**
	 * 发布点ID
	 */
	...
	/** full constructor */
	public MountInfo(Integer server_mount_id, String server_mount_name, ILiveServerGroup server_group,
			Integer storage_space, Integer used_space, String base_path, String ftp_path, Integer mount_type,
			Integer mirror_mount_id, String mount_desc, Integer if_use) {
		this.server_mount_id = server_mount_id;
