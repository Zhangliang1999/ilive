...
public class EquipmentOrder {
	...
	/**
	 * 预计人数  1 1000人以内   2 1000-1w人   3 1w人以上
	 */
	...
	public String toString() {
		return "EquipmentOrder [id=" + id + ", equipmentId=" + equipmentId + ", type=" + type + ", status=" + status
				+ ", area=" + area + ", startTime=" + startTime + ", endTime=" + endTime + ", contactName="
				+ contactName + ", contactPhone=" + contactPhone + ", createTime=" + createTime + ", updateTime="
				+ updateTime + ", userId=" + userId + ", applyAccount=" + applyAccount + ", rentOrSell=" + rentOrSell
				+ ", equipment=" + equipment + ", liveScene=" + liveScene + ", liveTime=" + liveTime + ", city=" + city
				+ ", predictNum=" + predictNum + ", predictDuration=" + predictDuration + ", predictBudget="
				+ predictBudget + ", otherDemand=" + otherDemand + ", isDel=" + isDel + "]";
	}
