myapp.controller("flowListAct", function($scope, $http, $state, $cookies, queryCondition, enterpriseBilling, flowService) {
	$scope.enterpriseBilling = enterpriseBilling;
	...
	$scope.viewSettlement = function() {
		$state.go("settlementList", {});
	}
});