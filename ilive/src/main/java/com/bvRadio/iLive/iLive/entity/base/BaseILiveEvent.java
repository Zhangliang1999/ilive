...
public abstract class BaseILiveEvent implements java.io.Serializable {
	...
	/**
	 * 观看授权方式 1公开观看 2密码观看 3付费观看 4白名单 5登录观看6F码观看
	 */
	 ...
	 * 当前状态是否为立刻插播视频
	 */
	private Integer nowInsertFile;
	/**
	 * F码欢迎语
	 * @return
	 */
	private String fcodeMsg;
	/**
	 * F码外链地址
	 * @return
	 */
	 ...
	 * @return
	 */
	private Timestamp lastPauseStopTime;
	/**
	 * 上一次暂停开始时间
	 * @return
	 */
	private Timestamp lastPauseStartTime;
	...
	public Integer getNowInsertFile() {
		return nowInsertFile;
	}

	public void setNowInsertFile(Integer nowInsertFile) {
		this.nowInsertFile = nowInsertFile;
	}

	public String getFcodeMsg() {
		return fcodeMsg;
	}

	public void setFcodeMsg(String fcodeMsg) {
		this.fcodeMsg = fcodeMsg;
	}
	...
	public Timestamp getLastPauseStopTime() {
		return lastPauseStopTime;
	}

	public void setLastPauseStopTime(Timestamp lastPauseStopTime) {
		this.lastPauseStopTime = lastPauseStopTime;
	}

	public Timestamp getLastPauseStartTime() {
		return lastPauseStartTime;
	}

	public void setLastPauseStartTime(Timestamp lastPauseStartTime) {
