...
public class BaseILiveServerAccessMethod {
	...
	private String recordServerAddr;
	/**
	 * 拉流 UMSIP
	 */
	private String umsIp;

	public String getRecordServerAddr() {
		return recordServerAddr;
	}

	public void setRecordServerAddr(String recordServerAddr) {
		this.recordServerAddr = recordServerAddr;
	}

	public String getUmsIp() {
		return umsIp;
	}

	public void setUmsIp(String umsIp) {
		this.umsIp = umsIp;
	}
