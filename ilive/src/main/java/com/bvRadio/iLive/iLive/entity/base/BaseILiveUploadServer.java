...
public abstract class BaseILiveUploadServer implements java.io.Serializable {
    ...
    private String convertTaskAddr;
	public BaseILiveUploadServer() {
	}

	
	public String getConvertTaskAddr() {
		return convertTaskAddr;
	}


	public void setConvertTaskAddr(String convertTaskAddr) {
		this.convertTaskAddr = convertTaskAddr;
	}
