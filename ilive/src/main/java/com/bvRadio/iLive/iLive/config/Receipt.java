...
public class Receipt {
	...
	public String toString() {
		return "Receipt [receipt_type=" + receipt_type + ", adam_id=" + adam_id + ", app_item_id=" + app_item_id
				+ ", bundle_id=" + bundle_id + ", application_version=" + application_version + ", download_id="
				+ download_id + ", version_external_identifier=" + version_external_identifier
				+ ", receipt_creation_date=" + receipt_creation_date + ", receipt_creation_date_ms="
				+ receipt_creation_date_ms + ", receipt_creation_date_pst=" + receipt_creation_date_pst
				+ ", request_date=" + request_date + ", request_date_ms=" + request_date_ms + ", request_date_pst="
				+ request_date_pst + ", original_purchase_date=" + original_purchase_date
				+ ", original_purchase_date_ms=" + original_purchase_date_ms + ", original_purchase_date_pst="
				+ original_purchase_date_pst + ", original_application_version=" + original_application_version
				+ ", in_app=" + in_app + "]";
	}
