...
public class WorkLog {
	 ...
	 * 当前系统systemId
	 */
	public final static Integer CURRENT_SYSTEM_ID = 100;
	 ...
	 * 往期回看
	 */
	public final static Integer MODEL_REVIEW = 110;
	 ...
	 * 媒体库上传视频
	 */
	public final static Integer MODEL_UPLOADVIDEO = 132;
	 ...
	 * @return
	 */
	public final static Integer MODEL_LHTD=205;
	public final static String MODEL_LHTD_NAME="领航套餐退订";
	...
	public Map<String, String> toParamsMap() {
		...
		paramsMap.put("contentName", contentName==null?"":contentName);
		paramsMap.put("userId", String.valueOf(userId));
		paramsMap.put("userName", userName==null?"":userName);
