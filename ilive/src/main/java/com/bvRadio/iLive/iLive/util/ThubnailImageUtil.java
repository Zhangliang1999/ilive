 ...
 *
 */
public class ThubnailImageUtil {

	private static String DEFAULT_PREVFIX = "thumb_";
	private static Boolean DEFAULT_FORCE = false;
	
	Logger logger = LoggerFactory.getLogger(ThubnailImageUtil.class);
	...
	public static void main(String[] args) {
		new ThubnailImageUtil().thumbnailImage("imgs/Tulips.jpg", 100, 150);
	}
