...
public class Constants {
	 ...
	 * 错误状态码 不存在
	 */
	public static final int NOFIND_STATUS = 404;
	 ...
	 * 未绑定手机号
	 */
	public static final int NOT_BIND_MOBILE = 402;
	/**
	 * 不是微信登录
	 */
	public static final int NOT_WEIXIN_LOGIN = 403;
	/**
	 * 鉴权失败
	 */
	 ...
	 * 观看码已被绑定
	 */
	public static final int FCODE_BIND=404;
	//*************************************************接口CODE定义错误结束****************************************
	/**
	 * 文字信息类型
	 */
	 ...
	 * 图片  文字混编   类型
	 */
	public static final int MSG_TYPE_IMG_TXT = 4;
	/**
	 * 视频  文字  混编类型:  
	 */
	public static final int MSG_TYPE_VIDEO_TXT = 5;
	 ...
	 * 上传excel
	 */
	public static final String UPLOAD_FILE_TYPE_Excel = "excel";
