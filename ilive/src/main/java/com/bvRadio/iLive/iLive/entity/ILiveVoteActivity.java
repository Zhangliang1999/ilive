 ...
 *
 */
public class ILiveVoteActivity implements Serializable{
	...
	private List<ILiveVoteProblem> list;
	...
	public List<ILiveVoteProblem> getList() {
		return list;
	}

	public void setList(List<ILiveVoteProblem> list) {
		this.list = list;
	}
