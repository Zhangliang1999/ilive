...
public class ILiveMessageController {
	 ...
	 * @param msgType  消息体类型  1 文字  2 图片
	 * @param response
	 */
	@RequestMapping(value="/save.do")
	public void saveILiveMessage(Integer msgType,Long userId,Integer roomId,String msgContent,Integer liveMsgType,String fontColor,Long liveEventId,Integer selectType, HttpServletResponse response,HttpServletRequest request){
		JSONObject resultJson = new JSONObject();
		try {
			if(roomId==null||userId==null||msgContent==null||liveMsgType==null||liveEventId==null||msgType==null){
				resultJson.put("code", ERROR_STATUS);
			...
			//iLiveMessage.setSenderName(iLiveManager.getMobile());
			//用户ID
...
//  话题 ==========================================================================================================================	
	 ...
	 * @param request
	 */
	@RequestMapping(value="/selectMessageLIVE.do")
		...
		try {
			...
			for (int i = 0; i < iLiveCommentsListYES.size(); i++) {
				for (int j = 1; j < iLiveCommentsListYES.size()-i; j++) {
					if ((iLiveCommentsListYES.get(j - 1).getCreateTime()).compareTo(iLiveCommentsListYES.get(j).getCreateTime()) < 0) {
			...
			for (int i = 0; i < iLiveCommentsListNO.size(); i++) {
				for (int j = 1; j < iLiveCommentsListNO.size()-i; j++) {
					if ((iLiveCommentsListNO.get(j - 1).getCreateTime()).compareTo(iLiveCommentsListNO.get(j).getCreateTime()) < 0) {
	 ...
	 * @param request
	 */
	@RequestMapping(value="/comments/selectCommentsAllByMsgId.do")
	 ...
	 * @param request
	 */
	@RequestMapping(value="/topic/comments/allow.do")
	public void updateCommentsAllow(Long evenId,Integer commentsAllow,HttpServletResponse response,HttpServletRequest request) {
		JSONObject resultJson = new JSONObject();
		try {
	 ...
	 * @param request
	 */
	@RequestMapping(value="/topic/comments/audit.do")
	public void updateCommentsAudit(Long evenId,Integer commentsAudit,HttpServletResponse response,HttpServletRequest request) {
		JSONObject resultJson = new JSONObject();
		try {
	 ...
	 * @param roomId ID
	 * @param guestsName  昵称
	 * @param guestsLabel 标签
	 * @param response
	 * @param request
	 */
	@RequestMapping(value="/topic/guests/update.do")
	public void updateILiveGuests(Integer roomId,String guestsName,String guestsLabel,HttpServletResponse response,HttpServletRequest request) {
		JSONObject resultJson = new JSONObject();
		try {
	 ...
	 * @param msgContent 发送内容
	 * @param iLiveEvent 场次ID
	 * @param msgType  消息体类型  1 文字  2 图片   3 视频   4 图片和文字  5 视频和文字
	 * @param images 图集路径
	 * @param videos 视频路径
	 * @param response
	 */
	@RequestMapping(value="/topic/save.do")
	public void saveTopicILiveMessage(Integer msgType,Integer roomId,String msgContent,Long liveEventId,String images,String videos, HttpServletResponse response,HttpServletRequest request){
		JSONObject resultJson = new JSONObject();
		try {
	 ...
	 * @param response
	 */
	@RequestMapping(value="/topic/update.do")
	public void updateTopicILiveMessage(Long msgId,Integer msgType,String msgContent,String images,String videos, HttpServletResponse response,HttpServletRequest request){
		JSONObject resultJson = new JSONObject();
		try {
			if(msgId==null){
				resultJson.put("code", ERROR_STATUS);
	 ...
	 * @param request
	 */
	@RequestMapping(value="/topic/clear.do")
	 ...
	 * @param request
	 */
	@RequestMapping(value="/topic/selectById.do")
	 ...
	 * @param request
	 */
	@RequestMapping(value="/topic/deleteById.do")
	 ...
	 * @param request
	 */
	@RequestMapping(value="/topic/comments/updateAuditById.do")
	public void updateCommentsAuditTopicById(Long commentsId,HttpServletResponse response,HttpServletRequest request) {
		JSONObject resultJson = new JSONObject();
		try {
	 ...
	 * @param request
	 */
	@RequestMapping(value="/topic/updateTop.do")
	public void updateTopicByIdOrTop(Long msgId,Integer top,HttpServletResponse response,HttpServletRequest request) {
		JSONObject resultJson = new JSONObject();
		try {
			ILiveMessage iLiveMessage = iLiveMessageMng.findById(msgId);
			iLiveMessage.setTop(top);
	 ...
	 * 评论禁言
	 * @param commentsId 评论ID
	 * @param estoppelType 禁言标示  1 禁言   0 否
	 * @param response
	 * @param request
	 */
	@RequestMapping(value="/topic/updateEstoppel.do")
	public void updateCommentsEstoppel(Long commentsId,Integer estoppelType,HttpServletResponse response,HttpServletRequest request) {
		JSONObject resultJson = new JSONObject();
		try {
			ILiveComments iLiveComments = iLiveCommentsMng.getILiveCommentsById(commentsId);
	 ...
	 * @param roomId 直播间ID
	 */
	@RequestMapping(value="/delete/estoppel.do")
	public void deleteEstoppelMessage(HttpServletResponse response,Long userId,Integer roomId){
		JSONObject resultJson = new JSONObject();
		try {
			ILiveEstoppel iLiveEstoppel = new ILiveEstoppel();
			iLiveEstoppel.setRoomId(roomId);
	...
	public void deleteReplyContentByMsgId(Integer roomId,Long msgId,HttpServletRequest request,HttpServletResponse response){
		JSONObject resultJson = new JSONObject();
		try {
			ILiveMessage iLiveMessage = iLiveMessageMng.findById(msgId);
			iLiveMessage.setDeleted(true);
