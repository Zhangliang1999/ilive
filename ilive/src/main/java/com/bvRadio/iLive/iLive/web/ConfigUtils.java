...
public class ConfigUtils {
	...
	public final static String CONVERT_TEMPLET = "convert_templet";
	public final static String CONVERT_SERVER = "convert_server";
	public final static String LOG_URL = "http://mgr.zbt.tv189.net/logServer/service/log/list";
