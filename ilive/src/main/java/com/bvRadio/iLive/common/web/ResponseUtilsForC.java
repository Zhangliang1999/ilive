 ...
 */
public final class ResponseUtilsForC {
	public static final Logger log = LoggerFactory.getLogger(ResponseUtilsForC.class);
	...
	public static void render(HttpServletResponse response, String contentType, String text) {
		try {
			...
			response.setHeader("Content-Length", String.valueOf(text.getBytes("GBK").length));
			response.setDateHeader("Expires", 0);
			System.out.println("Content-Length:"+ text.getBytes("GBK").length);
			response.setContentLength(text.getBytes("GBK").length);
