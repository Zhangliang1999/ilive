...
import com.bvRadio.iLive.common.security.userdetails.AccountStatusUserDetailsChecker;
import com.bvRadio.iLive.common.security.userdetails.UserDetails;
import com.bvRadio.iLive.common.security.userdetails.UserDetailsChecker;
import com.bvRadio.iLive.common.security.userdetails.UserDetailsService;
...
public abstract class AbstractRememberMeServices implements RememberMeService, InitializingBean {
	...
	public final UserDetails autoLogin(HttpServletRequest request, HttpServletResponse response) throws CookieTheftException {
		...
		try {
			...
			cancelCookie(request, response);
			log.debug("Remember-me login was valid but corresponding user not found.", noUser);
			return null;
	 ...
	 */
	protected abstract boolean onLoginSuccess(HttpServletRequest request, HttpServletResponse response, UserDetails user);
