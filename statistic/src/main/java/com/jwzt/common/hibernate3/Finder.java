package com.jwzt.common.hibernate3;
...
public class Finder {
	...
	public String getRowCountHql() {
		...
		// boolean ismache = rowCountHql.toLowerCase().matches("order[ ]+by");
		// int index2 = rowCountHql.indexOf(ORDER_BY);
		// int index =
		// rowCountHql.toLowerCase().matches("order[
		// ]+by")?rowCountHql.indexOf(ORDER_BY):-1;
		if (index > 0) {
