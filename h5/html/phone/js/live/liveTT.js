    ...
    ws.onmessage = function (e) {
        ...
        switch (roomType) {
            ...
            case 1:
                ...
                //如果全局禁言关闭 则判断个人禁言
                if (gable_estoppelType) { // 0 开启  1 关闭
                    if (userId === senderId) {
                        if (opType == 11) {
                            gable_estoppelType = 0 //禁言了
                            $('#chatipt').find('span').text('目前还不能讨论哦~')
    ...
    pageDecorate.forEach(function (value, index) {
        ...
        switch (value.menuType) {
            ...
            case 5:
                ...
                break
            case 6: //6文档
                $swiperContent.find('.swiper-wrapper').append('<div class="swiper-slide"><div class="wendang">文档</div></div>')
