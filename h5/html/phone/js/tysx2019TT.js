...
var _template = {
    page: function () {
        var dom = '<div class="videoBox">\n' +
            '        <video id="video" controls preload="auto" playsinline="playsinline"\n' +
    ...
    commentDom: function (value) {
        ...
        return str = '<div class="talkline' + cusotm.className + '" id="msgId_' + value.commentsId + '">\n' +
            ...
            '               </div>\n' +
            '             <div class="comment"><i class="' + cusotm.wenIcon + '"></i>' + value.comments + '' +
...
function showPopupContent(obj) {
    return '<div class="showPopupContent">' +
        '  <div class="body mescroll" id="mescroll_' + obj.id + '">' + obj.content + '</div>' +
        '</div>'
}
