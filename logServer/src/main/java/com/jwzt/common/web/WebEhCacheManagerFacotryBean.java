 ...
 */
public class WebEhCacheManagerFacotryBean implements FactoryBean<CacheManager>, InitializingBean, DisposableBean {
		...
		if (this.configLocation != null) {
			...
			if (this.diskStoreLocation != null) {
				...
				try {
					...
					log.warn("if you want to config distStore in spring," + " please remove diskStore in config file!",
							e);
				}
			}
		}
